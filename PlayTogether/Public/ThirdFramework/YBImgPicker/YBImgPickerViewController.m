...
@property (nonatomic , strong) id <YBImgPickerViewControllerDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate> delegate;
...
#pragma mark self
- (void)showInViewContrller:(UIViewController *)vc choosenNum:(NSInteger)choosenNum delegate:(id<YBImgPickerViewControllerDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate>)vcdelegate{
    
    self.delegate = vcdelegate;
    choosenCount = 0;
    photoCount = choosenNum;
    self.navigationItem.rightBarButtonItem.title = rightItemTitle;
